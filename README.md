# Nemesis Client  <img width="32" height="32" alt="Icon" src="src/main/resources/assets/nemesis/icon.png" />
...
![License](https://img.shields.io/github/license/7rn5/NemesisClient?label=License)
![Fabric](https://img.shields.io/badge/Fabric-1.21.4-orange?logo=fabricmc)
![Minecraft](https://img.shields.io/badge/Minecraft-1.21.4-green?logo=minecraft)
...
<details>
<summary><b>Movement [4]</b></summary>
...
<details>
<summary><b>Player [1]</b></summary>

- SpeedMine
</details>

<details>
<summary><b>Visual [1]</b></summary>

- NoRender
</details>

**Total Modules:** `15`  
_Last updated: 2025-12-22 14:29_
...
## このソースコードの公開について  JP
このコードを公開したのはただこのゲームに楽しさを感じなくなったからです。 
このゲームをしている人はほとんどのひとがバカで愚かだった(自分も含めて)  
こんなゲームをいつまでも続けることはしたくないからこのコードも今はどうでもいい  
使いたい人がいたら勝手にダウンロードして勝手に改造してください。できるだけskidはしないようにしているけどそんなことで争ってるやつらはほんとに愚かだと思う。  
多分このコードは公開から3日以内に消えてると思う。  


## Regarding the release of this source code  EN
