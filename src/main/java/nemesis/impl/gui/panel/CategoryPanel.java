...
public class CategoryPanel {
    ...
    private final Set<Module.Category> expandedCategories;
    ...
    public CategoryPanel(Module.Category moduleCategory, Set<Module.Category> expandedCategories, Set<Module> expandedModules) {
    ...
    public void render(DrawContext context, TextRenderer textRenderer, int x, int y, int mouseX, int mouseY, int screenHeight) {
        ...
        ColorManagement colorModule = getColorModule();
